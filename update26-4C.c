...
int main()
{
    ...
    const char option3[30] = "      EXIT GAME       ";
    int selected;
    int highlight = 0;
    ...
    while (loop == 1)
    {
        ...
        if (selected == 10)
        {
            ...
            case 0:
                c = 'w';
                clear();
                create_map_predefined(linhas, colunas, mapa); // mapa pre definido
                ...
                // arranjar o que acontece quando sai do jogo - menu tem de imprimir algo!?
                break;
            case 1:
                c = 'w';
                clear();
