...
{
if (c == ' ' && player1.gun == 1 && last_direction_moved == 'w') 
    {
        // if(mobposition==y-1doPlayer) //Se houver um mob em cima do player
        // {
        mob.hp -= 10;
        // }
    }
    ...
    {
        // if(mobposition==x-1doPlayer) //Se houver um mob a esquerda do player
        // {
        mob.hp -= 10;
        // } 
    }
    ...
    {
        // if(mobposition==y+1doPlayer) //Se houver um mob em baixo do player
        // {
        mob.hp -= 10;
        // } 
    }
...
{
if (c == ' ' && player1.gun == 2 &&  player1.ammo>0 && last_direction_moved == 'w' && bullet.number==0)
    {
    bullet.appearing=1;
    bullet.direction=1;
    bullet.number += 1;
...
{
if (mapa[bullet.positionY][bullet.positionX].visible_piece =='#') //|| mapa[bullet.positionY][bullet.positionX].visible_piece == MOB)
    {
    bullet.appearing=0;
    bullet.number=0;
    }
...
if (bullet.number==1 && bullet.appearing==1) // substituir por um switch /switch(bullet.direction)
        {
            if (bullet.direction==1) { mvaddch(bullet.positionY - 1 ,bullet.positionX,'*');  bullet.positionY -=1;}
            else if (bullet.direction==2) { mvaddch(bullet.positionY ,bullet.positionX - 1,'*'); bullet.positionX -=1; }
            else if (bullet.direction==3) { mvaddch(bullet.positionY + 1 ,bullet.positionX,'*'); bullet.positionY +=1;}
            else if (bullet.direction==4) { mvaddch(bullet.positionY ,bullet.positionX + 1,'*'); bullet.positionX +=1;}          
        }
}
else if (c == 'a')
{
