...
*/
void multi_jogo_win(int linhas, int colunas, Map mapa[][colunas], Mob *mobs, Game game, Flag flag, Bullet bullet_player1, Bullet bullet_player2, Player player1, Player player2, int mob_positionX, int mob_positionY)
{
    ...
    while (loop == 1)
    {
        ...
        if (selected == 10)
        {
            ...
            case 0: // Opção "Singleplayer"
                ...
                start_game_single_player(linhas, colunas, mapa, mobs, player1, player2, mob_positionX, mob_positionY);   // iniciamos o jogo
                main_game_single_player(game.key_pressed, linhas, colunas, mapa, game, player1, player2, mobs, flag, bullet_player1, bullet_player2, mob_positionX, mob_positionY); // damos update ao jogo
                clear();
                refresh();
                loop = 0;
                break;
            case 1: // Opção "Multiplayer"
                ...
                main_game_multi_player(game.key_pressed, linhas, colunas, mapa, game, player1, player2, flag, mobs, bullet_player1, bullet_player2); // damos update ao jogo
                clear();
                refresh();
                loop = 0;
                break;
...
void menu(int linhas, int colunas, Map mapa[][colunas], Mob *mobs, Game game, Flag flag, Bullet bullet_player1, Bullet bullet_player2, Player player1, Player player2, int mob_positionX, int mob_positionY)
{
    ...
    while (loop == 1)
    {
        ...
        if (selected == 10)
        {
            ...
            case 0:                                    // Opção "COMECAR NOVO JOGO!"
                multi_jogo_win(linhas, colunas, mapa, mobs, game, flag, bullet_player1, bullet_player2, player1, player2, mob_positionX, mob_positionY); // inicia a janela de singleplayer/multiplayer
                break;
            case 1: // Opção "QUERO SER DESAFIADO :D"
                ...
                main_game_challenge(game.key_pressed, linhas, colunas, mapa, flag, game, player1, player2, mobs, bullet_player1, bullet_player2, mob_positionX, mob_positionY); // damos update ao jogo
                clear();
                refresh();
                break;
