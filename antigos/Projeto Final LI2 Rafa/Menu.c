...
void buyMenu_win(int linhas, int colunas, Player *player)
{
    ...
    const char option1[13] = "   COMPRAR   ";
    const char option2[13] = "   COMPRAR   ";
    const char option3[13] = "   COMPRAR   ";
    const char option4[13] = "   COMPRAR   ";
    const char option5[13] = "  COMPRASTE  ";
    int selected;
    int highlight = 0;
    int loop = 1; // variavel para o loop do jogo
