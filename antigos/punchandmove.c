...
*/
// void mob_movement(Mob mob)
// {
//     float distancianormal = calc_dist(mob_positionY, player1.positionY, mob_positionX, player1.positionX);
...
//                 mob_positionX -= 1; //Anda Para a Esquerda
//             else if (distanciaUmParaEsquerda > distanciaUmParaBaixo)
//                 mob_positionY += 1; //Anda Para Baixo
//             else mob_positionY +=1;
//         }
...
//                 mob_positionX -= 1; // Anda para a Esquerda
//             else if (distanciaUmParaEsquerda > distanciaUmParaCima)
//                 mob_positionY -= 1; // Anda para Cima
//             else mob_positionY -=1;
//         }
...
//                 mob_positionX += 1; //Anda Para a Esquerda
//             else if (distanciaUmParaDireita > distanciaUmParaBaixo)
//                 mob_positionY += 1; //Anda Para Baixo
//             else mob_positionY +=1;
//         }
//         else if (player1.positionY < mob_positionY) // Se o Player tiver acima do mob
...
//                 mob_positionX += 1; // Anda para a Esquerda
//             else if (distanciaUmParaDireita > distanciaUmParaCima)
//                 mob_positionY -= 1; // Anda para Cima
//             else mob_positionY -=1;
//         }
//         else //Se o Player Tiver na mesma linha do Mob
...
//     {
//     if (player1.positionY < mob_positionY) mob_positionY -= 1;
//     else if (player1.positionY > mob_positionY) mob_positionY += 1;
//     }
// }
/*
esta funçao troca as armas do jogadores
